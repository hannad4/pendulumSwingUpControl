...
P_rotpen_quick_start_T rotpen_quick_start_P = {
  ...
  /* Computed Parameter: PendulumVelocity_A
   * Referenced by: '<Root>/Pendulum Velocity'
   */
  -50.0,

  /* Computed Parameter: PendulumVelocity_C
   * Referenced by: '<Root>/Pendulum Velocity'
   */
  -2500.0,

  /* Computed Parameter: PendulumVelocity_D
   * Referenced by: '<Root>/Pendulum Velocity'
   */
  50.0,
