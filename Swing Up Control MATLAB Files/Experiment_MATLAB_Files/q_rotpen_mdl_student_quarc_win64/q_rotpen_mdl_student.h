...
typedef struct {
  ...
  real_T HILInitialize_POSortedFreqs[2];/* '<S4>/HIL Initialize' */
  real_T HILInitialize_POValues[2];    /* '<S4>/HIL Initialize' */
  ...
  int32_T HILInitialize_DOStates;      /* '<S4>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[2];/* '<S4>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[2];/* '<S4>/HIL Initialize' */
  int32_T HILInitialize_POModeValues[2];/* '<S4>/HIL Initialize' */
  int32_T HILInitialize_POAlignValues[2];/* '<S4>/HIL Initialize' */
  int32_T HILInitialize_POPolarityVals[2];/* '<S4>/HIL Initialize' */
  int32_T HILReadEncoder_Buffer[2];    /* '<S4>/HIL Read Encoder' */
  uint32_T HILInitialize_POSortedChans[2];/* '<S4>/HIL Initialize' */
...
struct P_q_rotpen_mdl_student_T_ {
  ...
  uint32_T HILInitialize_EIQuadrature; /* Computed Parameter: HILInitialize_EIQuadrature
                                        * Referenced by: '<S4>/HIL Initialize'
                                        */
  uint32_T HILInitialize_POChannels[2];/* Computed Parameter: HILInitialize_POChannels
                                        * Referenced by: '<S4>/HIL Initialize'
                                        */
